export default (function() {
  ...
  function peg$parse(input, options) {
    ...
    var peg$FAILED = {},
        ...
        peg$c0 = function(res) {return res.reduce((acc, n) => [...acc, acc.slice(-1)[0] + n], [0]) },
        peg$c1 = ",",
        ...
        peg$c13 = function(list, space) { const s = space / list.reduce((sum,n) => sum + n);
        	  return list.map(n => n * s); },
        peg$c14 = function(n, d) { return [...new Array(n)].map((_, i) => d / n) },
        peg$c15 = "+",
        ...
        peg$c30 = peg$otherExpectation("float"),
        peg$c31 = /^[0-9]/,
